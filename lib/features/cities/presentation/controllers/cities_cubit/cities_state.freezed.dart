...
mixin _$CitiesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, List<CityEntity>> groupedCities)
    success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Map<String, List<CityEntity>> groupedCities)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, List<CityEntity>> groupedCities});
}
...
class __$$SuccessImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({Object? groupedCities = null}) {
    return _then(
      _$SuccessImpl(
        null == groupedCities
            ? _value._groupedCities
            : groupedCities // ignore: cast_nullable_to_non_nullable
                  as Map<String, List<CityEntity>>,
      ),
    );
  }
}
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(final Map<String, List<CityEntity>> groupedCities)
    : _groupedCities = groupedCities;

  final Map<String, List<CityEntity>> _groupedCities;
  @override
  Map<String, List<CityEntity>> get groupedCities {
    if (_groupedCities is EqualUnmodifiableMapView) return _groupedCities;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_groupedCities);
  }

  @override
  String toString() {
    return 'CitiesState.success(groupedCities: $groupedCities)';
  }
  ...
  int get hashCode => Object.hash(
    runtimeType,
    const DeepCollectionEquality().hash(_groupedCities),
  );
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(groupedCities);
  }
...
abstract class Success implements CitiesState {
  const factory Success(final Map<String, List<CityEntity>> groupedCities) =
      _$SuccessImpl;
...
class _$FailureImpl implements Failure {
  ...
  @override
  String toString() {
    return 'CitiesState.failure(apiErrorModel: $apiErrorModel)';
  }
