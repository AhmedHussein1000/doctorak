...
NotificationsState _$NotificationsStateFromJson(Map<String, dynamic> json) {
  return _NotificationsState.fromJson(json);
}
...
abstract class $NotificationsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<NotificationItemModel> notifications});
}
...
class _$NotificationsStateImpl extends _NotificationsState {
  const _$NotificationsStateImpl({
    final List<NotificationItemModel> notifications = const [],
  }) : _notifications = notifications,
       super._();

  factory _$NotificationsStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$NotificationsStateImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$NotificationsStateImplToJson(this);
  }
}
...
abstract class _NotificationsState extends NotificationsState {
  ...
  factory _NotificationsState.fromJson(Map<String, dynamic> json) =
      _$NotificationsStateImpl.fromJson;
